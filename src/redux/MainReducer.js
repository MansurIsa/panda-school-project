...
export const MainSlice = createSlice({
    ...
    reducers: {
        ...
        fixedSocialCommonHandle: (state,action)=>{
            if(state.fixedSocialIcons===true){
                state.fixedSocialIcons=false
            }else{
                state.fixedSocialIcons=true
            }
            
        },

        whatsappCloseIcon: (state,action)=>{
            state.whatsappChat=false
        },
        whatsappFixedIcon: (state,action)=>{
